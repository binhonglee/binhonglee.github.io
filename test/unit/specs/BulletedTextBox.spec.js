...
describe('BulletedTextBox', () => {
  ...
  it(`1 item with 2 details`, () => {
    ...
    })).to.equal('title Primary string - Secondary string (Date string) Point 1Point 2')
  })
  ...
  it(`1 item with no detail`, () => {
    ...
    })).to.equal('title Primary string - Secondary string (Date string) ')
  })
  ...
  it(`3 items with 2 details each`, () => {
    ...
    })).to.equal('title Primary string1 - Secondary string1 (Date string1) Point 1 of 1Point 2 of 1Primary string2 - Secondary string2 (Date string2) Point 1 of 2Point 2 of 2Primary string3 - Secondary string3 (Date string3) Point 1 of 3Point 2 of 3')
  })
  ...
  it(`3 items with no details (default)`, () => {
    ...
    expect(getRenderedText({items: threeItemObject})).to.equal('title Primary string1 - Secondary string1 (Date string1) Primary string2 - Secondary string2 (Date string2) Primary string3 - Secondary string3 (Date string3) ')
  })
  ...
  it(`3 items with no details (wide)`, () => {
    ...
    expect(getLineHeight(current)).to.equal('wide')
    expect(getRenderedText(current)).to.equal('title Primary string1 - Secondary string1 (Date string1) Primary string2 - Secondary string2 (Date string2) Primary string3 - Secondary string3 (Date string3) ')
  })
